...
\begin{frame}{The Nelson-Siegel Forward Rate and Yield Curve}
...
\begin{frame}{The Nelson-Siegel Yield Curve}
...
\begin{frame}{The Three Factor Loadings, One at a Time}
...
\begin{frame}{Worked Numeric Example (Part 1 of 2)}
...
\begin{frame}{Worked Numeric Example (Part 2 of 2)}

\begin{exampleblock}{Worked Numeric Example (continued)}
...
\begin{frame}{Priors in the Bayesian Formulation}
...
\begin{frame}{Figure: Toy Posterior Distributions of the NS Parameters}
  \centering
  \includegraphics[width=0.56\textwidth]{fig_toy_posteriors.pdf}

  \footnotesize Own toy simulation: posterior histograms from the
  from-scratch HMC sampler for $\beta_0,\beta_1,\beta_2,\lambda$, each with
  the true value marked -- all four fall well within the posterior mass.
\end{frame}
