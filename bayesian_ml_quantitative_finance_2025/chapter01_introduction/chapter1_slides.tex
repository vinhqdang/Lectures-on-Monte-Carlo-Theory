...
\begin{frame}{Why Machine Learning Meets Quantitative Finance}
...
\begin{frame}{The Open Questions Motivating This Book}
  \begin{block}{Intuition}
...
\begin{frame}{Coin Flip: From Prior to Posterior}
  ...
  \end{block}
  \centering
  \includegraphics[width=0.72\textwidth]{fig_bayes_coin.pdf}
\end{frame}
...
\begin{frame}{The Book's Four Themes}
  ...
  \end{block}
  \centering
  \includegraphics[width=0.98\textwidth]{fig_book_roadmap.pdf}
\end{frame}
