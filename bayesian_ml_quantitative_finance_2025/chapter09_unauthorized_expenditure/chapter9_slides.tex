...
where $\mathrm D = \{\vx, \mathbf{y}\}$ is the data, $N$ is the number of
...
\begin{center}
  \includegraphics[width=0.88\textwidth]{fig_hmc_vs_mhmc_schematic.pdf}
\end{center}
...
\begin{center}
  \includegraphics[width=0.6\textwidth]{fig_toy_data_scatter.pdf}
\end{center}
...
\begin{center}
  \includegraphics[width=0.62\textwidth]{fig_mh_vs_mala_toy.pdf}
\end{center}
{\scriptsize Own from-scratch simulation, illustrative only. MH tuned to
$\approx$31\% acceptance, MALA to $\approx$83\%. MALA's autocorrelation
decays faster (bottom-left): rough ESS out of 6{,}500 post-burn-in draws is
MH $\approx 663$ vs.\ MALA $\approx 905$ -- a small-scale echo of the
book's finding that gradient-informed samplers beat plain MH.}
\end{frame}
