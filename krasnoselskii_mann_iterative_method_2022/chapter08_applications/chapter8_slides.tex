...
On a toy example with $m=3$ coordinates, the diagram below contrasts the two update patterns: a fixed repeating order (top) vs.\ three concurrent agents with a stale read (bottom, dashed arrow, delay $\tau\ge1$).

\begin{center}
\includegraphics[width=0.78\linewidth]{fig_coordinate_updates.pdf}
\end{center}
...
\begin{frame}{Conclusion: The Book's Own Words}
...
\begin{frame}{Conclusion: The Arc of the Whole Book}
...
\begin{frame}{Conclusion: Takeaway}
